...
\bmhead{Declaration on the use of Generative Artificial Intelligence}
...
The dataset compiled from the Centro Nacional de Memoria Histórica (CNMH) microdata and the empirical calibration inputs are available in the public GitHub repository: \url{https://github.com/Donzhumber/IJGT.git}.

\subsection*{Code availability}
The complete replication codes (Stata scripts for calibration, Lean 4 interactive proofs, PyTorch training, and Streamlit simulation engine scripts) are available in the public GitHub repository: \url{https://github.com/Donzhumber/IJGT.git}.
