...
\subsection*{Mecanismo indirecto}
...
\subsection*{Núcleo de implementación endógena MDG}
...
\subsection*{Teorema de Identificación de Tipos Racionales}
...
\subsection*{Implementabilidad condicional en EBP}
...
\bmhead{Declaración sobre el uso de Inteligencia Artificial Generativa}
...
El autor no recibió financiación para esta investigación. Todo el trabajo fue desarrollado como una iniciativa independiente.

\subsection*{Conflicto de intereses}
El autor declara que no tiene intereses financieros ni no financieros en conflicto.

\subsection*{Aprobación ética}
No aplicable.

\subsection*{Consentimiento para participar}
No aplicable.

\subsection*{Consentimiento para publicación}
No aplicable.

\subsection*{Disponibilidad de datos}
El conjunto de datos compilado a partir de los microdatos del Centro Nacional de Memoria Histórica (CNMH) y los insumos de calibración empírica están disponibles en el repositorio público de GitHub: \url{https://github.com/Donzhumber/IJGT.git}.

\subsection*{Disponibilidad de código}
Los códigos de replicación completos (scripts de Stata para calibración, demostraciones interactivas en Lean 4, entrenamiento en PyTorch y scripts del motor de simulación de Streamlit) están disponibles en el repositorio público de GitHub: \url{https://github.com/Donzhumber/IJGT.git}.

\subsection*{Contribución del autor}
Humberto Bernal es el único autor de este trabajo y fue responsable de la conceptualización, demostraciones matemáticas, calibración en Stata, formalización en Lean 4, entrenamiento en PyTorch, implementación en Streamlit y redacción del manuscrito.
